Shader "URP/Environment/GrassSimple"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            half4 frag(Varyings IN) : SV_Target
            {
                ...
                // only modulate strongly on relatively flat ground
